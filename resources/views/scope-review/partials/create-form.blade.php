    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <select name="platform"
                ...
                @foreach(\App\Models\Platform::active()->ordered()->pluck('name') as $platformOption)
                    <option value="{{ $platformOption }}" {{ old('platform') === $platformOption ? 'selected' : '' }}>{{ $platformOption }}</option>
                @endforeach
            </select>
