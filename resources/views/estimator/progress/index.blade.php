...
<div class="py-12">
    <div class="max-w-10xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <h2 class="text-2xl font-semibold text-gray-900">My Progress</h2>
                    <a href="{{ route('estimator.progress.create') }}" 
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6">
                <form method="GET" action="{{ route('estimator.progress.index') }}" class="space-y-4">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <a href="{{ route('estimator.progress.show', $entry) }}" 
                                           class="text-blue-600 hover:text-blue-900">View</a>
                                        <a href="{{ route('estimator.progress.edit', $entry) }}" 
                                           class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                        <form method="POST" 
                                              action="{{ route('estimator.progress.destroy', $entry) }}" 
                                              class="inline"
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-4 text-center text-gray-500">
                                    No progress entries found. <a href="{{ route('estimator.progress.create') }}" class="text-blue-600 hover:text-blue-900">Create your first one</a>.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
