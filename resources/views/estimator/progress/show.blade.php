...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('estimator.progress.edit', $progress) }}" 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            @if($progress->project->other_gc && count($progress->project->other_gc) > 0)
                                <div class="space-y-2 mt-2">
                                    @foreach($progress->project->other_gc as $gcName => $gcData)
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">My Progress</h3>
        ...
        <div class="mt-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">My Measurements</h3>
                
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-blue-50 p-4 rounded-lg">
                        <label class="block text-sm font-medium text-blue-600 mb-1">Total Square Feet</label>
                        <p class="text-2xl font-bold text-blue-900">
                            {{ $progress->total_sqft ? number_format($progress->total_sqft, 2) . ' sq ft' : 'Not recorded' }}
                        </p>
                    </div>
                    ...
                    <div class="bg-green-50 p-4 rounded-lg">
                        ...
                        <p class="text-2xl font-bold text-green-900">
                            {{ $progress->total_lnft ? number_format($progress->total_lnft, 2) . ' ln ft' : 'Not recorded' }}
                        </p>
                    </div>
                    ...
                    <div class="bg-purple-50 p-4 rounded-lg">
                        ...
                        <p class="text-2xl font-bold text-purple-900">
                            {{ $progress->total_sinks ?? 'Not recorded' }}
                        </p>
                    </div>
                    ...
                    <div class="bg-orange-50 p-4 rounded-lg">
                        ...
                        <p class="text-2xl font-bold text-orange-900">
                            {{ $progress->total_slabs ?? 'Not recorded' }}
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-6 bg-gray-50 p-4 rounded-lg">
                    <label class="block text-sm font-medium text-gray-600 mb-1">Time Spent</label>
                    <p class="text-3xl font-bold text-gray-900">
                        {{ $progress->total_hours ? number_format($progress->total_hours, 2) . ' hours' : 'Not recorded' }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">My Performance Point</h3>
