...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <h2 class="text-2xl font-semibold text-gray-900">Edit Progress Entry</h2>
                    <a href="{{ route('estimator.progress.index') }}" 
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <form method="POST" action="{{ route('estimator.progress.update', $progress) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        <label for="project_id" class="block text-sm font-medium text-gray-700 mb-2">
                            My Project <span class="text-red-500">*</span>
                        </label>
                        <select id="project_id" 
                            ...
                            @foreach($projects as $project)
                                <option value="{{ $project->id }}" {{ (old('project_id', $progress->project_id) == $project->id) ? 'selected' : '' }}>
                                    {{ $project->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div id="projectInfo" class="mb-6 p-4 bg-gray-50 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <p id="projectStatus" class="text-sm text-gray-900">-</p>
                            </div>
                            <div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               id="job_number" 
                               name="job_number" 
                               value="{{ old('job_number', $progress->job_number) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="date" 
                                   id="assigned_date" 
                                   name="assigned_date" 
                                   value="{{ old('assigned_date', $progress->assigned_date?->format('Y-m-d')) }}"
                        ...
                        <div>
                            ...
                            <input type="date" 
                                   ...
                                   value="{{ old('submission_date', $progress->submission_date?->format('Y-m-d')) }}"
                            ...
                            @error('submission_date')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Leave blank if work is still in progress</p>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       step="0.01"
                                       min="0"
                                       value="{{ old('total_sqft', $progress->total_sqft) }}"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       step="0.01"
                                       min="0"
                                       value="{{ old('total_lnft', $progress->total_lnft) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       name="total_sinks" 
                                       min="0"
                                       value="{{ old('total_sinks', $progress->total_sinks) }}"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       name="total_slabs" 
                                       min="0"
                                       value="{{ old('total_slabs', $progress->total_slabs) }}"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" 
                               ...
                               step="0.25"
                               min="0"
                               value="{{ old('total_hours', $progress->total_hours) }}"
                        ...
                        @error('total_hours')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Track time spent on this project</p>
                    </div>
