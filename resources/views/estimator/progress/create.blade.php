    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <h2 class="text-2xl font-semibold text-gray-900">Add Progress Entry</h2>
        ...
        @if($projects->isEmpty())
            <div class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mb-6">
                <strong>No Projects Available:</strong> You don't have any projects assigned to you. Contact your administrator to assign projects.
            </div>
        @endif
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <form method="POST" action="{{ route('estimator.progress.store') }}">
                    @csrf
                    ...
                    @else
                        <div class="text-center py-12">
                            <p class="text-gray-500 mb-4">You don't have any projects assigned to you.</p>
                            <a href="{{ route('estimator.progress.index') }}" 
                               class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
                                Back to Progress
                            </a>
