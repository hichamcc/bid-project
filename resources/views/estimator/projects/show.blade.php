    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">RFI Details</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div>
                                        ...
                                        <a href="{{ Storage::disk('public')->url($project->first_rfi_attachment) }}" 
                                           target="_blank"
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500">Attachment</label>
                                        <a href="{{ Storage::disk('public')->url($project->second_rfi_attachment) }}" 
                                           target="_blank"
                                           class="inline-flex items-center text-blue-600 hover:text-blue-800 text-sm">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500">Attachment</label>
                                        <a href="{{ Storage::disk('public')->url($project->third_rfi_attachment) }}" 
                                           target="_blank"
                                           class="inline-flex items-center text-blue-600 hover:text-blue-800 text-sm">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
