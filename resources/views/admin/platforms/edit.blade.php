    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Edit Platform</h2>
                ...
                <form method="POST" action="{{ route('admin.platforms.update', $platform) }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="sort_order" value="{{ old('sort_order', $platform->sort_order) }}" min="0"
                        ...
                        <div>
                            <label class="flex items-center gap-2">
                                ...
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $platform->is_active) ? 'checked' : '' }}
