        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <h2 class="text-2xl font-semibold text-gray-900">Add New Type</h2>
                ...
                <form method="POST" action="{{ route('admin.types.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" 
                                  name="description" 
                                  rows="3"
                                  placeholder="Describe what this project type represents..."
                    ...
                    <div class="mb-6 p-4 bg-gray-50 rounded-md">
                        ...
                        <div class="flex items-center space-x-3">
                            <div id="color-preview" class="w-4 h-4 rounded-full" style="background-color: {{ old('color', '#8b5cf6') }}"></div>
                            <span id="name-preview" class="px-2 py-1 text-xs font-semibold rounded-full" style="background-color: {{ old('color', '#8b5cf6') }}20; color: {{ old('color', '#8b5cf6') }}">
                                {{ old('name', 'Type Name') }}
                            </span>
                        </div>
                    </div>
